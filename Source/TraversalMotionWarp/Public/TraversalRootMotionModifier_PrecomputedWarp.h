...
#include "TraversalRootMotionModifier_PrecomputedWarp.generated.h"

UENUM(Experimental)
enum class ETraversalPrecomputedWarpWeightCurveType
{
...
struct FTraversalPrecomputedWarpCurve
{
	GENERATED_BODY()
	
	// Type of curve to interpolate using
	UPROPERTY(EditAnywhere, Category = Properties)
	ETraversalPrecomputedWarpWeightCurveType CurveType = ETraversalPrecomputedWarpWeightCurveType::FromRootMotionTranslation;
...
USTRUCT(Experimental)
struct FTraversalPrecomputedWarpSteeringSettings
{
	GENERATED_BODY()
...
UENUM(Experimental)
enum class ETraversalPrecomputedWarpUpdateMode
{
...
class UTraversalRootMotionModifier_PrecomputedWarp : public UTraversalRootMotionModifier_Warp
{
	GENERATED_BODY()
...
public:
	...
	TRAVERSALMOTIONWARP_API UTraversalRootMotionModifier_PrecomputedWarp(const FObjectInitializer& ObjectInitializer);

	TRAVERSALMOTIONWARP_API virtual FTransform ProcessRootMotion(const FTransform& InRootMotion, float DeltaSeconds) override;

	UPROPERTY(EditAnywhere, Category = Blending, Meta = (EditCondition="!bSeparateTranslationCurves"))
	FTraversalPrecomputedWarpCurve TranslationWarpingCurve;
	...
	UPROPERTY(EditAnywhere, Category = Blending, Meta = (EditCondition="bSeparateTranslationCurves"))
	FTraversalPrecomputedWarpCurve TranslationWarpingCurve_InMovementDirection;
	UPROPERTY(EditAnywhere, Category = Blending, Meta = (EditCondition="bSeparateTranslationCurves"))
	FTraversalPrecomputedWarpCurve TranslationWarpingCurve_OutOfMovementDirection;
	
	UPROPERTY(EditAnywhere, Category = Blending)
	FTraversalPrecomputedWarpCurve RotationWarpingCurve;
	...
	UPROPERTY(EditAnywhere, Category = TargetTransform)
	ETraversalPrecomputedWarpUpdateMode UpdateMode;
	...
	FTraversalPrecomputedWarpSteeringSettings SteeringSettings;

	// Instance Data

	float GetWeight(float CurrentTime, const FTraversalPrecomputedWarpCurve& WarpCurve) const;
