...
#include "TraversalMotionWarpAttributeBasedRootMotionComponent.generated.h"
...
USTRUCT()
struct FTraversalMotionWarpAttributeBasedRootMotionTickFunction : public FTickFunction
{
	GENERATED_USTRUCT_BODY()

	/** CharacterMovementComponent that is the target of this tick **/
	class UTraversalMotionWarpAttributeBasedRootMotionComponent* Target;
...
template<>
struct TStructOpsTypeTraits<FTraversalMotionWarpAttributeBasedRootMotionTickFunction> : public TStructOpsTypeTraitsBase2<FTraversalMotionWarpAttributeBasedRootMotionTickFunction>
{
	enum
	{
		WithCopy = false
...
UENUM()
enum class ETraversalMotionWarpAttributeBasedRootMotionMode
{
	ApplyDelta,
	ApplyVelocity,
};
...
class UTraversalMotionWarpAttributeBasedRootMotionComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UE_API UTraversalMotionWarpAttributeBasedRootMotionComponent(const FObjectInitializer& ObjectInitializer);
	...
	ETraversalMotionWarpAttributeBasedRootMotionMode Mode = ETraversalMotionWarpAttributeBasedRootMotionMode::ApplyDelta;
	
protected:

	/** Pre-physics tick function for this character */
	FTraversalMotionWarpAttributeBasedRootMotionTickFunction PrePhysicsTickFunction;
